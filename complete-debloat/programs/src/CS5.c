...
int main(int argc, char **argv){
    ...
    if(!(stepx==0 && stepy==0) && 
        ((stepx >= 30 && stepx <=50 && stepy >=30 && stepy <=50) ||
        // (stepx >= 25 && stepx <=30 && stepy >=25 && stepy <=30) || 
        // (stepx >= 45 && stepx <=50 && stepy >=45 && stepy <=50) || 
        // (stepx >= 0 && stepx <=20 && stepy >=0 && stepy <=20) || 
        (stepx >= 100 && stepx <=130 && stepy >=10 && stepy <=20) || 
        (stepx >= 0 && stepx <=10 && stepy >=90 && stepy <=110))) {
      fprintf(fd_use, "%d %d\n", stepx, stepy);
