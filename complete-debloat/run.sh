...
echo -e "\n\n========================"
echo -e "Running Kondo and BF"
echo -e "========================\n\n"
python3 src/run.py

echo -e "\n\n==========================================================================="
echo -e "Sleeping to wait for AFL compilation"
...
echo -e "\n\n=========================================="
echo -e "Running offset space variation experiments"
echo -e "==========================================\n\n"
python3 offset_space_exp.py

echo -e "\n\n==========================================="
echo -e "Computing statistics from the generated data"
echo -e "===========================================\n\n"
python3 compute_stats.py

echo -e "\n\n========================================================"
echo -e "Running Kondo with varied center hull distance threshold"
echo -e "========================================================\n\n"
